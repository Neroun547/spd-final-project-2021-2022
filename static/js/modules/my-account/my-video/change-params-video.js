...
const changeParamsVideoForm = document.getElementById("change-params-video-form");
...
changeParamsVideoForm.addEventListener("submit", async function (e) {
    ...
    try {
        const api = await apiService.apiCall(`/my-video/change-params-video/${idVideo}`, "PUT", JSON.stringify(
